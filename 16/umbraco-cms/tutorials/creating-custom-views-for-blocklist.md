...
Read about [extension-manifest](../customizing/extending-overview/extension-registry/extension-manifsdfsdfest.md) to learn how to register an Extension Manifest.
